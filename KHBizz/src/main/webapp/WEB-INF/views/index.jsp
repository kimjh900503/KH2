...
.btn-vivid-red:focus { background-color: #b42424; color: #fff; border-color: #b42424; }
	...
	<body class="no-trans front-page">
		...
		<div class="page-wrapper">
																		...
																		<div class="row">
																			<div class="col-sm-6 col-md-3">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/index-corporate-4.html"><i class="icon-home pr-10"></i>Corporate 4 <span class="badge">NEW</span></a></li>
																			...
																			<div class="col-sm-6 col-md-3">
																				...
																				<ul class="menu">
																					...
																					<li ><a href="template/index-gym.html"><i class="fa fa-heartbeat pr-10"></i>Gym <span class="badge">NEW</span></a></li>
																					<li ><a href="template/index-resume.html"><i class="fa fa-user pr-10"></i>Resume <span class="badge">NEW</span></a></li>
																					<li ><a href="template/index-agency.html"><i class="fa fa-users pr-10"></i>Agency <span class="badge">NEW</span></a></li>
																					<li ><a href="template/index-logistics.html"><i class="fa fa-truck pr-10"></i>Logistics <span class="badge">NEW</span></a></li>
																				</ul>
																			</div>
																		</div>
																	</div>
														...
														<ul class="dropdown-menu">
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	...
																	<li ><a href="template/features-headers-gradient-dark.html">Gradient Dark <span class="badge">NEW</span></a></li>
																	<li ><a href="template/features-headers-gradient-light.html">Gradient Light <span class="badge">NEW</span></a></li>
															...
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	...
																	<li ><a href="template/features-headers-sticky-2.html">Alternative <span class="badge">NEW</span></a></li>
																</ul>
															</li>
															<li class="dropdown ">
															...
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	...
																	<li ><a href="template/features-footers-contact-form-2.html#footer">Contact Form 2 <span class="badge">NEW</span></a></li>
																	...
																	<li ><a href="template/features-footers-full-width.html#footer">Full Width <span class="badge">NEW</span></a></li>
																</ul>
															</li>
															<li class="dropdown ">
																...
																<ul class="dropdown-menu">
																	...
																	<a  class="dropdown-toggle" data-toggle="dropdown" href="#">Revolution 4</a>
																		<ul class="dropdown-menu">
																			<li ><a href="template/features-sliders-revolution-4-fullscreen.html">Full Screen</a></li>
																			<li ><a href="template/features-sliders-revolution-4-fullwidth.html">Full Width</a></li>
																			<li ><a href="template/features-sliders-revolution-4-fullwidth-big-height.html">Full Width - Big Height</a></li>
																			<li ><a href="template/features-sliders-revolution-4-boxedwidth-light.html">Boxed Width - Light Bg</a></li>
																			<li ><a href="template/features-sliders-revolution-4-boxedwidth-dark.html">Boxed Width - Dark Bg</a></li>
																			<li ><a href="template/features-sliders-revolution-4-boxedwidth-default.html">Boxed Width - Default Bg</a></li>
																			<li ><a href="template/features-sliders-revolution-4-video-background.html">Video Background</a></li>
																			<li ><a href="template/features-sliders-revolution-4-text-rotator.html">Text Rotator</a></li>
																		</ul>
																	</li>
																</ul>
															</li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 text-center col-md-offset-2 space-bottom">
							...
							<p class="text-center lead object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">Multipurpose HTML5 Template - More than 185+ HTML files.</p>
			...
			<section class="pv-40">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span>Corporate 4</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span>Agency</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span>Gym</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span>Logistics</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">NEW</span>Resume</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>Construction</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>Education</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>Hotel</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
						...
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>Blog</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
					...
					<div class="row">
						<div class="col-sm-4">
							<h3><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>Beauty Center</h3>
							<div class="image-box shadow bordered text-center mb-20">
								<div class="overlay-container">
			...
			<section class="pv-40">
				<div class="container">
					<h3 class="text-center"><span class="text-default" style="font-weight:300; font-size: 16px; padding-right:10px;">v.1.1</span>HTML email templates</h3>
					<div class="row">
